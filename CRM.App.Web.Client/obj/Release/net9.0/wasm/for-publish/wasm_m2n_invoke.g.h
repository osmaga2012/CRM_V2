...
static void
wasm_invoke_iiiiiiliii (void *target_func, MonoInterpMethodArguments *margs)
{
	typedef int (*T)(int arg_0, int arg_1, int arg_2, int arg_3, int arg_4, int64_t arg_5, int arg_6, int arg_7, int arg_8);
	T func = (T)target_func;
	int res = func (mono_wasm_interp_method_args_get_iarg (margs, 0), mono_wasm_interp_method_args_get_iarg (margs, 1), mono_wasm_interp_method_args_get_iarg (margs, 2), mono_wasm_interp_method_args_get_iarg (margs, 3), mono_wasm_interp_method_args_get_iarg (margs, 4), mono_wasm_interp_method_args_get_larg (margs, 5), mono_wasm_interp_method_args_get_iarg (margs, 7), mono_wasm_interp_method_args_get_iarg (margs, 8), mono_wasm_interp_method_args_get_iarg (margs, 9));
	void *retval = mono_wasm_interp_method_args_get_retval (margs);
	*(int*)retval = res;
}
